        ...
        <main>
            ...
            <div class="form-style-5">
                ...
                <fieldset>
                    ...
                    <form action="departementUpdate.php" method="POST">
                    ...
                    <a href="<?=$_SERVER['HTTP_REFERER']?>" style="padding: 15px;align-content: center ;display: block;margin-left: 1000px">

                        <i class="fa fa-arrow-circle-left fa-lg" aria-hidden="true" style="color: #1d4b8f"><span title="Back" cla>Retour</span></i>
                    </a>
